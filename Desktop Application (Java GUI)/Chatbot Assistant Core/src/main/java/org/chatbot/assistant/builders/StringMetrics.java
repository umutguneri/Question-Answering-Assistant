...
final class StringMetrics {
	...
	public static StringMetric create(Metric<String> metric) {
		return org.chatbot.assistant.metrics.StringMetrics.create(metric);
	}

	
	public static StringMetric create(Metric<String> metric, Simplifier simplifier) {
		return org.chatbot.assistant.metrics.StringMetrics.create(metric,simplifier);
	}

	
	public static StringMetric createForListMetric(Metric<List<String>> metric, Simplifier simplifier,
			Tokenizer tokenizer) {
		return org.chatbot.assistant.metrics.StringMetrics.createForListMetric(metric,simplifier, tokenizer);

	}

	
	public static StringMetric createForListMetric(Metric<List<String>> metric, Tokenizer tokenizer) {
		return org.chatbot.assistant.metrics.StringMetrics.createForListMetric(metric, tokenizer);
	}

	
	public static StringMetric createForSetMetric(Metric<Set<String>> metric, Simplifier simplifier,
			Tokenizer tokenizer) {
		return org.chatbot.assistant.metrics.StringMetrics.createForSetMetric(metric,simplifier, tokenizer);
	}

	
	public static StringMetric createForSetMetric(Metric<Set<String>> metric, Tokenizer tokenizer) {
		return org.chatbot.assistant.metrics.StringMetrics.createForSetMetric(metric, tokenizer);
	}
	...
	public static StringMetric createForMultisetMetric(Metric<Multiset<String>> metric, Simplifier simplifier,
			Tokenizer tokenizer) {
		return org.chatbot.assistant.metrics.StringMetrics.createForMultisetMetric(metric,simplifier, tokenizer);
	}

	
	public static StringMetric createForMultisetMetric(Metric<Multiset<String>> metric, Tokenizer tokenizer) {
		return org.chatbot.assistant.metrics.StringMetrics.createForMultisetMetric(metric, tokenizer);
	}
