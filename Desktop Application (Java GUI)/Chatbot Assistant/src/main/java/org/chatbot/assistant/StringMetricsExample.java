...
/**
 * The StringMetrics utility class contains a predefined list of well known
...
public final class StringMetricsExample {
	...
	/**
	 * Using the string metric builder similarity metrics can be customized. Instead
	 * of a whitespace tokenizer a q-gram tokenizer is used.
	 *
