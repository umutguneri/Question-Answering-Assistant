...
import static org.chatbot.assistant.builders.StringDistanceBuilder.with;
...
public final class StringDistanceBuilderExample {
	 ...
	 * 
	 * The exact combination is generally domain specific. The StringDistanceBuilder
	 ...
	 * Tokenization
	 * 
	 * A metric can be used to measure the distance between strings. However not all
	 * metrics can operate on strings directly. Some operate on lists, sets or
